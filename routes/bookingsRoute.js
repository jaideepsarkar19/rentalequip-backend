...
const Equipment = require("../models/bikeModel");
...
router.post("/bookequipment", async (req, res) => {
  ...
  try {
    ...
    if (payment) {
      ...
      const equipment = await Equipment.findOne({ _id: req.body.equipment });
      console.log(req.body.equipment);
      equipment.bookedTimeSlots.push(req.body.bookedTimeSlots);
